try:
    ...
    print("Warning: 'tkinter' is not installed. GUI functionality will be disabled.")
    tk = None
    TclError = Exception
...
try:
    ...
    ThemedTk = None
    print("Warning: 'ttkthemes' is not installed. GUI functionality will be disabled.")
...
if tk:
    ...
    class PostConfigGUI(tk.Tk):
        ...
        def update_selections(self):
            selected_benchmarks = [
                self.benchmark_listbox.get(i)
                for i in self.benchmark_listbox.curselection()
            ]
            selected_code_libs = [
                self.code_lib_listbox.get(i)
                for i in self.code_lib_listbox.curselection()
            ]
    ...
    class PostConfigGUI:
        def __init__(self, *args, **kwargs):
            print(
                "Warning: GUI functionality is disabled because 'tkinter' is not installed."
            )
            self.window = None
...
if __name__ == "__main__":
    if tk:
        ...
        print("The GUI cannot be launched because 'tkinter' is not installed.")
